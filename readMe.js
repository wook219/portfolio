...
const readmeContents = {
    ...
    project2: {
        ...
        content: `
            ...
            <h2>Meaning</h2>
            <p>
            팀장으로 활동했던 프로젝트였습니다. 이전 프로젝트에서의 팀장 경험을 바탕으로 스크럼은 매일 하되,
            짧고 간결하게 진행하고 개발 시간을 최대한 많이 가져가려는 노력을 했습니다. 팀원들과 4주라는 기간동안
            하루 대부분의 시간을 같이 상주하였기에 힘들어도 격려하며 분위기를 많이 끌어올리려 노력을 많이 했던 것 
            같습니다. 모두 잘 따라와주고 이끌어줘서 좋은 성적을 낼 수 있었습니다.
            </p>
    ...
    project3: {
        ...
        content: `
            ...
            <p>
            팀장으로 활동해본 프로젝트였습니다. 정해진 규칙들을 준수하며 스크럼 시간을 적극 활용했으며,
            간단한 프로젝트지만 2주가 안되는 짧은 시간 동안 팀원 모두 배운 내용들을 한번씩 적용해보려고
            많은 노력을 했던 프로젝트였고, 좋은 성적을 낼 수 있었습니다.
            </p>
